...
const ExperienceForm = ({data, onChange}) => {
  ...
  const [generatingIndex, setGeneratingIndex] = useState(-1);
    ...
    const generateDescription = async (index) => {
       ...
       const prompt = `enhance the job description ${experince.description} for the position of ${experince.position} at ${experince.company}`
       ...
       {data.length === 0 ? (
        ...
        <div className='space-y-4'>
          {data.map((experience, index)=>(
            <div key = {index} className='p-4 border-1 border-gray-200 rounded-lg sapce-y-3'>
            ...
            <div className='grid md:grid-cols-2 gap-3'>
             ...
             type = "month"  className='px-3 py-2 text-sm rounded-lg disabled:bg-gray-100'/>
                ...
                <label className='flex items-center gap-2 pt-3 pb-3'>
