...
import { ArrowLeft, Briefcase, ChevronLeft, ChevronRight, Download, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, Sparkles, UserIcon } from 'lucide-react';
...
const ResumeBuilder = () => {
  ...
  const { token } = useSelector((state) => state.auth);
   ...
   const handleShare = () => {
    ...
    const resumeUrl = frontendUrl + '/view/' + resumeId.resumeId
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
             ...
             <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from indigo-500 to-indigo-600 border-none transaction-all duration-2000' 
             style = {{width:`${activeSectionIndex * 100/(sections.length)}%`}}/>
             ...
             <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
               ...
               <div className='flex items-center'>
                {activeSectionIndex !== 0 && (
                 ...
                 <button onClick={() => setActiveSectionIndex((prevIndex)=>Math
                  .min(prevIndex + 1,sections.length - 1))}
